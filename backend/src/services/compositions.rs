    ...
    let sample = vec![
        Composition {
            ...
            meta: CompositionMeta {
                ...
                playrate: 0.12,
                contest_rate: 0.18,
                set_version: "15".to_string(),
                min_round: Some(3),
                max_round: Some(6),
                econ_type: Some("Mid".to_string()),
                positioning_style: Some("Frontline".to_string()),
            },
            matchups: None,
        ...
        Composition {
            ...
            meta: CompositionMeta {
                ...
                min_round: Some(2),
                max_round: Some(5),
                econ_type: Some("Early".to_string()),
                positioning_style: Some("Split".to_string()),
            },
            matchups: None,
            votes: Votes { upvotes: 0, downvotes: 0 },
            views: 0,
